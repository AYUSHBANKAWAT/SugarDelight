package com.application.sugarrush.ui.fragments.overview
...
import com.application.sugarrush.databinding.FragmentOverviewBinding
...
class OverviewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //Log.d("data",binding.titleTextView.text.toString() )
       binding.titleTextView2.text =  myBundle?.title.toString()
        ...
        binding.summaryTextView.setTextColor(ContextCompat.getColor(requireContext(),R.color.black))
